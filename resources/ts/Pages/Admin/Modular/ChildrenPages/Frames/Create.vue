<template>
    ...
    >
        <div class="p-4 md:p-7 space-y-5">
            ...
            <div>
                <div class="block text-sm text-gray-500 mb-2">Frame Types {{ child_page_id }}</div>
...
const formData = {
    child_page_id: props.child_page_id,
    label: null,
    frame_type: null,
};
...
const pages = [
    {
        href: route("admin.pages.child.create-frame", props.child_page_id),
        name: "Frames",
    },
    {
        href: "",
...
* Functions
*--------------*/
const submitUrl = route("admin.pages.child.store-frame", props.child_page_id);
