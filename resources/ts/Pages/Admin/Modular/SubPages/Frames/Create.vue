<template>
    ...
    >
        <div class="p-4 md:p-7 space-y-5">
            ...
            <div>
                <div class="block text-sm text-gray-500 mb-2">Frame Types {{ sub_page_id }}</div>
...
const pages = [
    {
        href: route("admin.pages.subpage.create-frame", props.sub_page_id),
        name: "Frames",
    },
    {
        href: "",
...
* Functions
*--------------*/
const submitUrl = route("admin.pages.subpage.store-frame", props.sub_page_id);
