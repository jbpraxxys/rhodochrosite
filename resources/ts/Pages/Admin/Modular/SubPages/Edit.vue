    ...
    >
        ...
        <div>
            <Tabs
                ...
                :tab-route="route('admin.pages.subpage.edit', item.id)"
                :preserve-state="true"
            />
        </div>
        ...
        <div class="p-4 !pt-0 md:p-7">
            ...
            <frame-index 
                ...
                :create-route="'admin.pages.subpage.create-frame'" 
                :edit-route="'admin.pages.subpage.edit-frame'" 
                :id="item.id" 
                :frames="frames"
            />
            <children-index 
...
* Functions
*--------------*/
const submitUrl = route("admin.pages.subpage.update", props.item.id);
