    ...
    <user-layout>
        ...
        <general-banner 
            :item="{
                ...
                title: '<h1>Streamlined Virtual<br>Assistant </h1>'
            }"
        />  

        <offset-banner 
            :item="{
                title: '<h4>Seamless support, anytime,<br>anywhere, with virtual assistant<br>outsourcing.</h4>',
        ...
        <generic-block 
            ...
            :item="{
                title: 'Why Choose Virtual Assistants from Reliasourcing?',
