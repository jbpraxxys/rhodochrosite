<template>
	<div
		class="relative h-screen flex overflow-hidden bg-white dark:bg-gray-800"
	>
		...
		<div class="hidden lg:flex lg:flex-shrink-0">
			...
			>
				...
				<div class="h-0 flex-1 flex flex-col overflow-y-auto">
					...
					<Menu
						as="div"
						class="px-3 mt-3 relative inline-block text-left"
					>
						<div>
							<MenuButton
								class="
					...
					<div
						class="w-full border-t mt-3 border-gray-200 shadow-sm"
					></div>
					<!-- Navigation -->
					<nav class="px-3 mt-3">
						<h3
...
export default {
	...
	setup(props) {
		...
		function goBack() {
			const url =
				props.backUrl === null
					? props.breadcrumbPages[props.breadcrumbPages.length - 2]
							.href
					: props.backUrl;
			Inertia.visit(url);
		}
